    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                skip = (page - 1) * limit;
                return [4 /*yield*/, Movie_1.default.find().skip(skip).limit(limit)];
            case 2:
                movies = _a.sent();
                res
                    .status(200)
                    .json({ success: true, movies: movies, pagination: { total: total, pageCount: pageCount, page: page } });
                return [2 /*return*/];
        }
    });
}); };
...
var getMovie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, Movie_1.default.findById(id)];
            case 1:
                movie = _a.sent();
